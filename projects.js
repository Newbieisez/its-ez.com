(function(){
  ...
  var projects=[
    ...
    {
      id:'twilio-gong-intelligence',index:'04',company:'Twilio',title:'Gong Conversational Intelligence Architecture & Data Pipeline',role:'Senior Sales Enablement Manager',timeline:'2022–2024',type:'Conversation intelligence + performance analytics',metrics:['400+ participants','SOAR catalyst','VoC telemetry'],
    ...
    {
      id:'cofense-rebrand',index:'08',company:'Cofense / PhishMe',title:'Rebrand & GTM Realignment — PhishMe to Cofense',role:'Senior Revenue & Go-To-Market Enablement Leader',timeline:'Global rebrand',type:'Change management + field activation',metrics:['Zero pipeline disruption','+4% win rate','−21 days cycle'],
  ...
  var visuals={
    'sentinelone-partner-architecture':{
      ...
      evidence:[['Video learning','Working with Channel Partners','Representative partner learning asset connected to the wider readiness architecture.','Working%20with%20Channel%20Partners.mp4'],['Architecture','8-Week Enablement Accelerator','Representative implementation architecture for diagnosing, building, piloting and measuring enablement.','#artifact-accelerator'],['Framework','4-Stage Enablement Framework','Know → Practice → Prove → Perform applied as a readiness model.','#artifact-framework']]
    },
    'sentinelone-partnerstruck':{
      ...
      evidence:[['Experience design','QR Learning Journey','Physical SKO moments connected to measurable mobile learning.',null],['Automation','Remediation Loop','Failing scores triggered targeted follow-up learning instead of manual administration.',null],['Gamification','Partnerstruck Reward','A memorable branded reward made ecosystem mastery visible, social, and fun.',null]]
    },
    'twilio-soar':{
      ...
      evidence:[['Performance model','4-Stage Enablement Framework','Representative model for moving from knowledge to demonstrated performance.','#artifact-framework'],['Architecture','8-Week Enablement Accelerator','Representative sequence for design, pilot, rollout and measurement.','#artifact-accelerator'],['Scorecard','GTM Productivity Outcomes','Validated outcomes presented as measurable performance evidence.','#artifact-kpis']]
    },
    'twilio-gong-intelligence':{
      ...
      evidence:[['Intelligence map','Conversation-to-Enablement Loop','Customer conversations became a structured input into program design.',null],['Analytics','Custom Tracker Architecture','Behavioral, competitive, and objection signals organized for repeatable analysis.',null],['Program linkage','SOAR Catalyst','Conversation intelligence identified the competency gaps addressed by SOAR.',null]]
    },
    'enterprise-revenue-acceleration':{
      ...
      evidence:[['Operating model','Revenue Acceleration Loop','Field skill, manager reinforcement, workflow, and measurement connected as one system.',null],['Readiness','Enterprise Onboarding','Structured ramp architecture replacing fragmented training.',null],['Scorecard','Enterprise Performance Outcomes','Revenue, win-rate and cycle-time improvements as the proof layer.','#artifact-kpis']]
    },
    'global-experiential-engine':{
      window:'Career-wide · recurring quarterly cadence',
      ...
      evidence:[['Cadence','Global Enablement Calendar','A recurring operating rhythm designed to prevent coverage gaps.',null],['Experience','Gamified Learning Engine','Jeopardy, fishbowls, competitive workshops and live scoring increased active participation.',null],['Methodology','MEDDPICC Practice System','Experiential practice supported 82% methodology adoption.',null]]
    },
    'cybersecurity-threat-enablement':{
      window:'Cybersecurity enterprise GTM execution',
      ...
      evidence:[['Curriculum','Threat-Centric Enablement','Complex security concepts translated into role-specific field learning.',null],['Technical track','SE + Security Engineer Readiness','Advanced technical paths supported PoC and demo execution.',null],['Qualification','Cybersecurity Discovery Model','Security buyer personas and qualification tied to enterprise buying motions.',null]]
    },
    'cofense-rebrand':{
      window:'Global PhishMe → Cofense transition',
      ...
      evidence:[['Change plan','Rebrand Enablement Masterplan','Corporate strategy translated into coordinated field readiness.',null],['Sales artifact','Messaging + Battlecard Overhaul','Legacy terminology replaced with the expanded security narrative.',null],['Technical artifact','SE Alignment','Technical workshops ensured the new automation story held up in demonstrations.',null]]
    }
  };

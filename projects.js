(function(){
  ...
  var BRAND_ART={
    sentinelone:'sentinelone-logo.svg?v=20260907-cleanup',
    twilio:'assets/twilio-logo.svg?v=20260907-cleanup'
  };
  ...
  function init(){enhanceWork();enhancePreviews();setupNavHighlight();}

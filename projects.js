(function(){
  function runEnhancements(){
    ...
    if(work){
      var workTitle=work.querySelector('.section-title');
      var workIntro=work.querySelector('.body-copy');
      if(workTitle)workTitle.textContent='Here’s what I’ve actually built.';
      if(workIntro)workIntro.textContent='Real GTM challenges, the operational architectures designed to solve them, and the verified business outcomes.';
    }

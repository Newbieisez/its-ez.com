...
(() => {
  ...
  const styles = `
    ...
    .ez-human-card{min-height:150px;padding:20px;border:1px solid rgba(0,0,0,.18);border-radius:16px;background:#fff;display:flex;flex-direction:column;justify-content:space-between;color:#171717;text-decoration:none;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}
    ...
    .ez-human-card[href]:hover{transform:translateY(-2px);border-color:#ef1717;box-shadow:0 10px 24px rgba(0,0,0,.08)}
  ...
  function replaceResults(){
    ...
    section.innerHTML=`<div class="wrap">
      ...
      <div class="ez-org-grid" aria-label="Measured outcomes by organization">
        ...
        <article class="ez-org-card"><small>Revenue readiness</small><h3>Twilio</h3><div class="ez-org-metric"><strong>$8M</strong><span>Pipeline growth supported</span></div><div class="ez-org-metric"><strong>82%</strong><span>MEDDPICC adoption</span></div><div class="ez-org-metric"><strong>Global</strong><span>Readiness system spanning training, methodology, coaching, and workflow</span></div></article>
  ...
  function addHumanLeadership(){
    ...
    section.innerHTML=`<div class="wrap"><div class="ez-human-head"><div><p class="ez-human-kicker">Beyond the job description</p><h2 id="ez-human-title">The work matters. So do the people.</h2></div><p class="ez-human-copy">I care about the systems that help people perform, and I care about the people inside those systems. My ERG and community work has included empathy, women’s empowerment, Pride, and support for diabetes and heart research. I do not see that as separate from leadership. It is part of how I show up.</p></div><div class="ez-human-grid" aria-label="Community and employee resource group priorities"><article class="ez-human-card"><small>People</small><strong>Empathy & belonging</strong></article><article class="ez-human-card"><small>Advocacy</small><strong>Women’s empowerment</strong></article><article class="ez-human-card"><small>Inclusion</small><strong>Pride & belonging</strong></article><a class="ez-human-card" href="https://www2.breakthrought1d.org/" target="_blank" rel="noopener noreferrer" aria-label="Visit Breakthrough T1D"><small>Community support</small><strong>Diabetes research ↗</strong></a><a class="ez-human-card" href="https://www.heart.org/" target="_blank" rel="noopener noreferrer" aria-label="Visit the American Heart Association"><small>Community support</small><strong>Heart research ↗</strong></a></div></div>`;
